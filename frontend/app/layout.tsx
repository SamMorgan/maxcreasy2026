...
export default async function RootLayout({children}: LayoutProps<'/'>) {
  ...
  return (
    <html lang="en" className={`${FacilityBook.variable} bg-white text-black antialiased overscroll-none md:text-[clamp(12px,1.25vw,18px)]`}>
      <body className="font-facility-book text-[0.875rem] leading-[1.125rem]">
        ...
        <Header />
        <div className="w-full h-full overflow-auto fixed top-0 left-0 overscroll-none">
