...
export default function InfoPage({info, suggestedLocale}: InfoPageProps) {
  ...
  return (
    <>
      <article className="px-9 py-25 md:flex gap-24 md:pt-7 md:pb-7.75 max-md:pb-above-dot md:[&>div]:max-w-[min(42ch,33vw)] flex-1 [&_p+p]:mt-4.5 [&_a]:hover:opacity-30 [&_em]:italic">
